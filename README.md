...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,616 | 🐛 10 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [FlexASIO](https://github.com/dechamps/FlexASIO) ⭐ 2,015 | 🐛 66 | 🌐 C++ | 📅 2024-06-27 (windows-only) - FlexASIO is a universal ASIO driver, that supports WASAPI (shared and exclusive), KS, DirectSound and MME.
...
* [Jacktrip](https://github.com/jacktrip/jacktrip) ⭐ 1,051 | 🐛 42 | 🌐 C++ | 📅 2026-08-23 - multi-machine audio system used for network music performance over the Internet, that may offer the best latency using uncompressed audio.
