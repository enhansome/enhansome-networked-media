...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,778 | 🐛 10 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [qpwgraph](https://github.com/rncbc/qpwgraph) ⭐ 721 | 🐛 50 | 🌐 C++ | 📅 2026-08-26 (linux only) - qpwgraph is a graph manager dedicated to PipeWire, using the Qt C++ framework, based and pretty much like the same of QjackCtl.
...
* [Jack](https://jackaudio.org/) - cross-platform API that enables device sharing and also inter-application audio routing.
  * \[[JackRouter on Windows](https://jackaudio.org/faq/jack_on_windows.html)] \[[Catalina support discussion](https://github.com/jackaudio/jackaudio.github.com/issues/92) ⭐ 482 | 🐛 41 | 🌐 HTML | 📅 2026-08-11]
...
* [Jamulus](https://github.com/corrados/jamulus) ⭐ 1,133 | 🐛 180 | 🌐 C | 📅 2026-09-18 - software that enables musicians to perform real-time jam sessions over the internet, with clients connecting to a central server.
...
* [streamlabs](https://github.com/stream-labs/streamlabs-obs/) ⭐ 4,851 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-19 - open source streaming software built on OBS and Electron.
* [MiroTalk P2P](https://github.com/miroslavpejic85/mirotalk) ⭐ 4,742 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-17 - Free webRTC - P2P - simple, secure, fast real-time video conferences with support for up to 4k resolution and 60fps.
