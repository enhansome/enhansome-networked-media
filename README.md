...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,749 | 🐛 10 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [Jamulus](https://github.com/corrados/jamulus) ⭐ 1,132 | 🐛 176 | 🌐 C | 📅 2026-09-13 - software that enables musicians to perform real-time jam sessions over the internet, with clients connecting to a central server.
* [Jacktrip](https://github.com/jacktrip/jacktrip) ⭐ 1,054 | 🐛 41 | 🌐 C++ | 📅 2026-08-30 - multi-machine audio system used for network music performance over the Internet, that may offer the best latency using uncompressed audio.
...
* [streamlabs](https://github.com/stream-labs/streamlabs-obs/) ⭐ 4,849 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-13 - open source streaming software built on OBS and Electron.
