...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,693 | 🐛 12 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [FlexASIO](https://github.com/dechamps/FlexASIO) ⭐ 2,022 | 🐛 66 | 🌐 C++ | 📅 2024-06-27 (windows-only) - FlexASIO is a universal ASIO driver, that supports WASAPI (shared and exclusive), KS, DirectSound and MME.
* [qpwgraph](https://github.com/rncbc/qpwgraph) ⭐ 711 | 🐛 47 | 🌐 C++ | 📅 2026-08-26 (linux only) - qpwgraph is a graph manager dedicated to PipeWire, using the Qt C++ framework, based and pretty much like the same of QjackCtl.
...
* [Jack](https://jackaudio.org/) - cross-platform API that enables device sharing and also inter-application audio routing.
  * \[[JackRouter on Windows](https://jackaudio.org/faq/jack_on_windows.html)] \[[Catalina support discussion](https://github.com/jackaudio/jackaudio.github.com/issues/92) ⭐ 481 | 🐛 41 | 🌐 HTML | 📅 2026-08-11]
...
* [Jamulus](https://github.com/corrados/jamulus) ⭐ 1,129 | 🐛 178 | 🌐 C | 📅 2026-09-04 - software that enables musicians to perform real-time jam sessions over the internet, with clients connecting to a central server.
* [Jacktrip](https://github.com/jacktrip/jacktrip) ⭐ 1,051 | 🐛 41 | 🌐 C++ | 📅 2026-08-30 - multi-machine audio system used for network music performance over the Internet, that may offer the best latency using uncompressed audio.
...
* [EasyRTC](https://github.com/open-easyrtc/open-easyrtc) ⭐ 411 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-03 - WebRTC based implementation, originally forked from [priologic](https://github.com/priologic/).
...
* [Syphon Virtual Webcam](https://community.troikatronix.com/topic/6742/syphon-virtual-webcam) (mac-only) - free, open-source app for macOS that routes Syphon video to a virtual web cam, allowing apps that don't offer Syphon input to receive a Syphon video signal.
  * \[[github](https://github.com/TroikaTronix/Syphon-Virtual-Webcam) ⭐ 38 | 🐛 2 | 🌐 Objective-C | 📅 2026-07-14]
* [ZoomISO](https://www.liminalet.com/zoomiso) (mac-only) - export HD video streams from Zoom calls.

### Video Networking

* [streamlabs](https://github.com/stream-labs/streamlabs-obs/) ⭐ 4,845 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-05 - open source streaming software built on OBS and Electron.
* [MiroTalk P2P](https://github.com/miroslavpejic85/mirotalk) ⭐ 4,718 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-05 - Free webRTC - P2P - simple, secure, fast real-time video conferences with support for up to 4k resolution and 60fps.
