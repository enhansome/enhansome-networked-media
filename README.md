# Awesome Networked Media with stars
...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,557 | 🐛 8 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [FlexASIO](https://github.com/dechamps/FlexASIO) ⭐ 2,009 | 🐛 66 | 🌐 C++ | 📅 2024-06-27 (windows-only) - FlexASIO is a universal ASIO driver, that supports WASAPI (shared and exclusive), KS, DirectSound and MME.
* [qpwgraph](https://github.com/rncbc/qpwgraph) ⭐ 690 | 🐛 44 | 🌐 C++ | 📅 2026-08-04 (linux only) - qpwgraph is a graph manager dedicated to PipeWire, using the Qt C++ framework, based and pretty much like the same of QjackCtl.
...
* [Jack](https://jackaudio.org/) - cross-platform API that enables device sharing and also inter-application audio routing.
  * \[[JackRouter on Windows](https://jackaudio.org/faq/jack_on_windows.html)] \[[Catalina support discussion](https://github.com/jackaudio/jackaudio.github.com/issues/92) ⭐ 480 | 🐛 40 | 🌐 HTML | 📅 2026-08-11]
...
* [Jamulus](https://github.com/corrados/jamulus) ⭐ 1,120 | 🐛 170 | 🌐 C | 📅 2026-08-13 - software that enables musicians to perform real-time jam sessions over the internet, with clients connecting to a central server.
* [Jacktrip](https://github.com/jacktrip/jacktrip) ⭐ 1,050 | 🐛 41 | 🌐 C++ | 📅 2026-06-08 - multi-machine audio system used for network music performance over the Internet, that may offer the best latency using uncompressed audio.
...
* [JackTrip WebRTC](https://github.com/jacktrip-webrtc/jacktrip-webrtc) ⭐ 396 | 🐛 22 | 🌐 JavaScript | 📅 2022-12-13 (TBA) - JackTrip WebRTC is an HTML5 implementation of Jacktrip for the web browser.
* [JamTaba 2](https://github.com/elieserdejesus/JamTaba/) ⭐ 255 | 🐛 164 | 🌐 C++ | 📅 2022-02-08 - play online music jam sessions with musicians around the world using ninjam servers.
...
* [Jamtrip](https://github.com/vicwomg/jamtrip) ⭐ 28 | 🐛 8 | 🌐 TypeScript | 📅 2021-04-01 - A cross-platform, electron-based, graphical user interface (GUI) front end for JackTrip and JACK.
...
* [raspberry-jam](https://github.com/rbultman/raspberry-jam) ⚠️ Archived - Use a Raspberry Pi and audio shield to connect musicians, or poets, together from distant locations.
* [Quack4](https://github.com/fdch/Quack4) ⭐ 5 | 🐛 0 | 🌐 Max | 📅 2020-08-07 - A quacktrip v0.5 plugin that handles a 3 way connection.
...
* [AOO](https://git.iem.at/cm/aoo) - Audio over OSC is aimed to be a message based audio system using Open Sound Control OSC\_ as a syntax format.
...
* [icecast](https://icecast.org/) - streaming media server which currently supports Ogg (Vorbis and Theora), Opus, WebM and MP3 streams.
  * [ŻyweRadio](https://github.com/kfirmanty/zywe-radio) ⭐ 2 | 🐛 0 | 🌐 CSS | 📅 2020-03-15 - online radio using icecast to broadcast stream of music performed live.
...
* [Link Audio](https://www.youtube.com/watch?v=dL5AZ5s8VLc) - Ableton protocol that lets you and your peers stream audio between Link Audio-enabled devices on a local network in real time.
  * see also: \[[Live 12.4 is coming](https://www.ableton.com/en/blog/live-12-4-is-coming/)]
...
* [netsend\~](http://www.nullmedium.de/dev/netsend~/) - (old) streaming externals for Max/MSP and Pure Data that allow high quality, uncompressed multichannel audio to be transmitted over LAN or Internet2 with very low latency.
  * see also: \[[udpsend\~](https://github.com/pd-l2ork/pd/blob/master/externals/mrpeach/net/udpsend~.c) ⭐ 127 | 🐛 15 | 🌐 C | 📅 2020-08-22] \[[\~bcast](https://github.com/joniemi/dist-conv) ⭐ 0 | 🐛 0 | 🌐 C | 📅 2016-07-22]
...
* [jit.ndi](https://github.com/impsnldavid/jit.ndi) ⭐ 79 | 🐛 10 | 🌐 C | 📅 2026-01-16 - Extensions for sending/receiving video and audio using the Newtek NDI® protocol in Cycling 74's Max.
...
* [Syphon Virtual Webcam](https://community.troikatronix.com/topic/6742/syphon-virtual-webcam) (mac-only) - free, open-source app for macOS that routes Syphon video to a virtual web cam, allowing apps that don't offer Syphon input to receive a Syphon video signal.
  * \[[github](https://github.com/TroikaTronix/Syphon-Virtual-Webcam) ⭐ 37 | 🐛 2 | 🌐 Objective-C | 📅 2026-07-14]
* [ZoomISO](https://www.liminalet.com/zoomiso) (mac-only) - export HD video streams from Zoom calls.

### Video Networking

* [streamlabs](https://github.com/stream-labs/streamlabs-obs/) ⭐ 4,835 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-13 - open source streaming software built on OBS and Electron.
* [MiroTalk P2P](https://github.com/miroslavpejic85/mirotalk) ⭐ 4,691 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - Free webRTC - P2P - simple, secure, fast real-time video conferences with support for up to 4k resolution and 60fps.
...
* [fourhands](https://github.com/jminjie/fourhands) ⭐ 34 | 🐛 4 | 🌐 JavaScript | 📅 2024-06-05 - Fourhands uses WebRTC to establish p2p connetions for minimal latency 2-person jamming using MIDI keyboards.

* [TR-P2P](https://github.com/samcar17/TR-P2P) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2023-03-12 - Node.js server and p5.js client for a networked MIDI sequencer
...
* [LoopMIDI](https://www.tobias-erichsen.de/software/loopmidi.html) - Virtual loopback MIDI cable for Windows.
