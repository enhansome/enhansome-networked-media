...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,617 | 🐛 10 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [qpwgraph](https://github.com/rncbc/qpwgraph) ⭐ 701 | 🐛 47 | 🌐 C++ | 📅 2026-08-04 (linux only) - qpwgraph is a graph manager dedicated to PipeWire, using the Qt C++ framework, based and pretty much like the same of QjackCtl.
...
* [Jamulus](https://github.com/corrados/jamulus) ⭐ 1,123 | 🐛 180 | 🌐 C | 📅 2026-08-23 - software that enables musicians to perform real-time jam sessions over the internet, with clients connecting to a central server.
* [Jacktrip](https://github.com/jacktrip/jacktrip) ⭐ 1,051 | 🐛 43 | 🌐 C++ | 📅 2026-08-24 - multi-machine audio system used for network music performance over the Internet, that may offer the best latency using uncompressed audio.
...
* [streamlabs](https://github.com/stream-labs/streamlabs-obs/) ⭐ 4,841 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-24 - open source streaming software built on OBS and Electron.
* [MiroTalk P2P](https://github.com/miroslavpejic85/mirotalk) ⭐ 4,703 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - Free webRTC - P2P - simple, secure, fast real-time video conferences with support for up to 4k resolution and 60fps.
