...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,676 | 🐛 12 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [qpwgraph](https://github.com/rncbc/qpwgraph) ⭐ 709 | 🐛 47 | 🌐 C++ | 📅 2026-08-26 (linux only) - qpwgraph is a graph manager dedicated to PipeWire, using the Qt C++ framework, based and pretty much like the same of QjackCtl.
...
* [Jamulus](https://github.com/corrados/jamulus) ⭐ 1,128 | 🐛 180 | 🌐 C | 📅 2026-08-31 - software that enables musicians to perform real-time jam sessions over the internet, with clients connecting to a central server.
...
* [streamlabs](https://github.com/stream-labs/streamlabs-obs/) ⭐ 4,843 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-02 - open source streaming software built on OBS and Electron.
* [MiroTalk P2P](https://github.com/miroslavpejic85/mirotalk) ⭐ 4,713 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-02 - Free webRTC - P2P - simple, secure, fast real-time video conferences with support for up to 4k resolution and 60fps.
