...
* [Black Hole](https://github.com/ExistentialAudio/BlackHole) ⭐ 19,655 | 🐛 12 | 🌐 C | 📅 2026-08-11 (mac-only) - virtual audio driver that allows applications to pass audio to other applications (16 ch).
...
* [Jamulus](https://github.com/corrados/jamulus) ⭐ 1,125 | 🐛 183 | 🌐 C | 📅 2026-08-28 - software that enables musicians to perform real-time jam sessions over the internet, with clients connecting to a central server.
...
* [MiroTalk P2P](https://github.com/miroslavpejic85/mirotalk) ⭐ 4,710 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - Free webRTC - P2P - simple, secure, fast real-time video conferences with support for up to 4k resolution and 60fps.
